...
/**
 * <p>
 * This is effectively a one to one mapping to Redis commands. And that is
 * basically it.
 * <p>
 * Beyond that , just be aware that an implementation may throw
 * {@link ClientRuntimeException} or an extension to report problems (typically
 * connectivity) or features {@link NotSupportedException} or bugs. These are
...
public interface JRedis {
    ...
    // * @return the {@link JavaSemantics} for type <code>T</code>, if the type
    // specified meets
    // * the required initialization characteristics.
    // */
    // public <T> JavaSemantics<T> semantic (Class<T> type) throws
     ...
     *             (as of ver. 0.09) in case of unauthorized access
     */
     ...
     * @throws RedisException
     *             A failure occurred starting the transaction
     */
     ...
     * 
     * @throws RedisException
     *             A failure occurred committing the transaction
     */
     ...
     * 
     * @throws RedisException
     *             A failure occurred rolling back the transaction
     */
     ...
     * @Redis SET
     * @param key
     *            any UTF-8 {@link String}
     * @param value
     *            any bytes. For current data size limitations, refer to Redis
     *            documentation.
     * @throws RedisException
     *             on user error.
     * @throws ProviderException
     *             on un-documented features/bug
     * @throws ClientRuntimeException
     *             on errors due to operating environment (Redis or network)
     */
     ...
     * implementation specific. Simple implementations may apply the basic
     * {@link Serializable} protocol.
     * 
     * @Redis SET
     * @param <T>
     * @param key
    ...
    public <T extends Serializable> boolean setnx(String key, T object)
            throws RedisException;
    ...
    public <T extends Serializable> byte[] getset(String key, T object)
            throws RedisException;
     ...
     * @Redis MSET
     * @param keyValueMap
     *            a {@link Map}ping of {@link String} key names to byte[]
     *            values.
     * @return
     * @throws RedisException
     */
    ...
    public <T extends Serializable> void mset(KeyValueSet.Objects<T> mappings)
            throws RedisException;
     ...
     *            a {@link Map}ping of {@link String} key names to byte[]
     *            values.
     * @return false if ANY of the keys in the map already existed, true if all
     *         were new and were set.
     * @throws RedisException
     */
    public boolean msetnx(Map<String, byte[]> keyValueMap)
            throws RedisException;

    public boolean msetnx(KeyValueSet.ByteArrays mappings)
            throws RedisException;
    ...
    public <T extends Serializable> boolean msetnx(
            KeyValueSet.Objects<T> mappings) throws RedisException;
    ...
    public <T extends Serializable> long append(String key, T object)
            throws RedisException;
     ...
     * @param key
     * @param UNIX
     *            epoch-time in <b>milliseconds</b>. Note that Redis expects
     *            epochtime in seconds. Implementations are responsible for
     *            converting to seconds. method
     * @return
     * @throws RedisException
     * @see {@link System#currentTimeMillis()}
     */
    public boolean expireat(String key, long epochtimeMillisecs)
            throws RedisException;
    ...
    public <T extends Serializable> void rpush(String listkey, T object)
            throws RedisException;
    ...
    public <T extends Serializable> void lpush(String listkey, T object)
            throws RedisException;
     ...
     * @throws RedisException
     */
    public long lrem(String listKey, byte[] value, int count)
            throws RedisException;

    public long lrem(String listKey, String stringValue, int count)
            throws RedisException;
     ...
     * @throws RedisException
     */
    public List<byte[]> lrange(String listkey, long from, long to)
            throws RedisException;
     ...
     * @throws RedisException
     */
    public void ltrim(String listkey, long keepFrom, long keepTo)
            throws RedisException;
    ...
    public boolean sadd(String setkey, Number numberValue)
            throws RedisException;

    public <T extends Serializable> boolean sadd(String setkey, T object)
            throws RedisException;
    ...
    public boolean srem(String setKey, Number numberValue)
            throws RedisException;

    public <T extends Serializable> boolean srem(String setKey, T object)
            throws RedisException;
     ...
     * @throws RedisException
     */
    public boolean sismember(String setKey, byte[] member)
            throws RedisException;

    public boolean sismember(String setKey, String stringValue)
            throws RedisException;

    public boolean sismember(String setKey, Number numberValue)
            throws RedisException;

    public <T extends Serializable> boolean sismember(String setKey, T object)
            throws RedisException;
     ...
     * @throws RedisException
     */
    public void sunionstore(String destSetKey, String... sets)
            throws RedisException;
     ...
     * @throws RedisException
     */
    public void sdiffstore(String destSetKey, String... sets)
            throws RedisException;
     ...
     * @throws RedisException
     */
    public boolean zadd(String setkey, double score, byte[] member)
            throws RedisException;

    public boolean zadd(String setkey, double score, String stringValue)
            throws RedisException;

    public boolean zadd(String setkey, double score, Number numberValue)
            throws RedisException;

    public <T extends Serializable> boolean zadd(String setkey, double score,
    ...
    public boolean zrem(String setKey, Number numberValue)
            throws RedisException;

    public <T extends Serializable> boolean zrem(String setKey, T object)
            throws RedisException;
    ...
    public Double zscore(String setkey, Number numberValue)
            throws RedisException;

    public <T extends Serializable> Double zscore(String setkey, T object)
            throws RedisException;
    ...
    public <T extends Serializable> long zrank(String setkey, T object)
            throws RedisException;
    ...
    public long zrevrank(String setkey, String stringValue)
            throws RedisException;

    public long zrevrank(String setkey, Number numberValue)
            throws RedisException;

    public <T extends Serializable> long zrevrank(String setkey, T object)
            throws RedisException;
     ...
     * @throws RedisException
     */
    public List<byte[]> zrange(String setkey, long from, long to)
            throws RedisException;
     ...
     * @throws RedisException
     */
    public List<byte[]> zrevrange(String setkey, long from, long to)
            throws RedisException;

    /**
     * Equivalent to {@link JRedis#zrange(String, long, long)} with the
     * {@link Command.Options#WITHSCORES}. Unlike the general ZRANGE command
     * that only returns the values, this method returns both values and
     * associated scores for the specified range.
     * 
     ...
     * @see ZSetEntry
     */
    public List<ZSetEntry> zrangeSubset(String setkey, long from, long to)
            throws RedisException;

    /**
     * Equivalent to {@link JRedis#zrevrange(String, long, long)} with the
     * {@link Command.Options#WITHSCORES}. Unlike the general ZREVRANGE command
     * that only returns the values, this method returns both values and
     * associated scores for the specified range.
     * 
     ...
     * @see ZSetEntry
     */
    public List<ZSetEntry> zrevrangeSubset(String setkey, long from, long to)
            throws RedisException;
     ...
     * @throws RedisException
     */
    public List<byte[]> zrangebyscore(String setkey, double minScore,
     ...
     * @throws RedisException
     */
    public long zremrangebyscore(String setkey, double minScore, double maxScore)
            throws RedisException;
     ...
     * @throws RedisException
     */
    public long zremrangebyrank(String setkey, double minRank, double maxRank)
            throws RedisException;
     ...
     */
    @Redis(versions = "1.07")
    public Double zincrby(String setkey, double score, byte[] member)
            throws RedisException;

    public Double zincrby(String setkey, double score, String stringValue)
            throws RedisException;

    public Double zincrby(String setkey, double score, Number numberValue)
            throws RedisException;

    public <T extends Serializable> Double zincrby(String setkey, double score,
            T object) throws RedisException;
     ...
     * @throws RedisException
     */
    public long zcount(String setkey, double minScore, double maxScore)
            throws RedisException;
     ...
     */
    @Redis(versions = "1.3.n")
    public boolean hset(String key, String field, String string)
            throws RedisException;
     ...
     */
    @Redis(versions = "1.3.n")
    public boolean hset(String key, String field, Number number)
            throws RedisException;
    ...
    // JRedisCommandSequence)
    // * and have that interface declare discard and multi. Benefit is being
    // able
     ...
     * implementations will select db 0 on connecting if non was specified.
     * Remember that there is no roll-back.
     * 
     * @Redis FLUSHDB
     * @return
     * @throws RedisException
    ...
    /**
     * Flushes all dbs in the connect Redis server, regardless of which db was
     * selected on connect time. Remember that there is no rollback.
     * 
     * @Redis FLUSHALL
     * @return
     * @throws RedisException
     ...
     * </pre></code>
     * <p>
     * Sort specification elements are also can appear in any order -- the
     * client implementation will send them to the server in the order expected
     * by the protocol, although it is good form to specify the predicates in
     * natural order:
     * <p>
     * <code><pre>
    ...
    public <T extends Serializable> byte[] echo(T msg) throws RedisException;
